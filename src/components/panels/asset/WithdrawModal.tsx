...
export default function WithdrawModal(props: {
  ...
  const { openWithdrawModal, setOpenWithdrawModal } = props;

  return (
    <Transition.Root show={openWithdrawModal} as={Fragment}>
      <Dialog as="div" className="relative z-10" onClose={setOpenWithdrawModal}>
        <Transition.Child
          as={Fragment}
              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-gray-800 px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    ...
                    >
                      Cannot withdraw test USDC
                    </Dialog.Title>
                    <div className="mt-2">
                      <p className="text-sm text-gray-400">
                        Withdrawal of test USDC is not supported. Please use
                        this feature in mainnet.
                      </p>
                    </div>
                  </div>
                </div>
